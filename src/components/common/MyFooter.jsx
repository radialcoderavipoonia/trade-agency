...
import { Facebook_logo, Insta_logo, Linkin_logo, Twitter_logo } from "./Icons";
  ...
  return (
    <>
      <footer className="py-lg-5 py-3">
        ...
        <div className="mt-3">
          <p className="m-0 ff_roboto fw-light text-white fs_1x7l text-center mt-lg-5 mt-3 pt-4">
            © Copyright 2023
          </p>
        </div>
      </footer>
